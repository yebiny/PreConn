...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/nibey/Desktop/psycopy_ex/ex_3types_block/types_lastrun.py',
...
start_text = visual.TextStim(win=win, name='start_text',
    text='This is Face test.\npress the space bar when you ready.',
    font='Arial',
    pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
for thisTrial in Trial:
    ...
    Block = data.TrialHandler(nReps=1, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('files/all_images.xlsx', selection=select_row),
    ...
    # update component parameters for each repeat
    # keep track of which components have finished
    restComponents = [rest_poly, rest_text]
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        # *rest_text* updates
        if rest_text.status == NOT_STARTED and tThisFlip >= 13.0-frameTolerance:
            # keep track of start time/frame for later
